...
export const Button: {
    ...
    if ("href" in commonProps) {
        return <AriaLink {...(commonProps as any)} href={disabled ? "" : (href as string)} />;
    }

    return <AriaButton {...(commonProps as any)} type={commonProps.type || "button"} isPending={loading ?? false} />;
};
